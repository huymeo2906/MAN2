      ...
      <div className={styles.coverParent}>
        ...
        <div className={styles.frameParent2}>
          <div className={styles.frameParent3}>
            <div className={styles.frameParent4}>
              ...
              src="/ueditalt21.svg"
               />
              <div className={styles.text}>Chỉnh sửa</div>
             </button>
            </div>
       ...
       />
              ...
              <div className={styles.input3}>
                <div className={styles.label4}>
                  <span>*</span>
                  <span className={styles.username}> Họ và tên</span>
                </div>
                <div className={styles.input2}>
                  <img
                    className={styles.outlineSearch}
            ...
            <div className={styles.inputGroup}>
              ...
              <div className={styles.input1}>
                <div className={styles.label4}>
                  <span>*</span>
                  <span className={styles.username}> Giới tính</span>
                </div>
                <div className={styles.input2}>
                  <img
                    className={styles.outlineSearch}
              ...
              <div className={styles.input1}>
                <div className={styles.label4}>
                  <span>*</span>
                  <span className={styles.username}> Số điện thoại</span>
                </div>
                <div className={styles.input2}>
                  <img
                    className={styles.outlineSearch}
